...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/timetravel/Public/Admin/css/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="/timetravel/Public/Admin/css/default_color.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('Public/loginCheck');?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>时光之旅管理平台</h3>
	...
	<!--[if lt IE 9]>
    <script type="text/javascript" src="/timetravel/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]-->
    <!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/timetravel/Public/static/jquery-2.0.3.min.js"></script>
    <!--<![endif]-->
