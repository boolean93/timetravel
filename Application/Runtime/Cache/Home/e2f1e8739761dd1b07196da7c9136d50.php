	...
	<div id="r_box">
		...
		<div class="r_form">
			...
			<form action="#" method="post">
				...
				<p>
					<input class="r_email" type="text" name="email" />
				</p>
				<span>登陆密码<b class="config_psw"></b></span>
				<p>
					<input class="r_psw" type="password" name="psw" />
				</p>
				
				<span>重复密码<b class="config_repsw"></b></span>
				<p>
					<input class="r_repsw" type="password" name="repsw" />
				</p>
				...
				<p>
					<input class="code_box" type="text" /><span class="code_pic">验证码图片</span>
				</p>
