...
<table class="table table-hover table-striped table-bordered">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo (get_my_readable_title($vo["readable"])); ?></td>
			<td>
                ...
                <?php if($vo["readable"] != 1): ?><a class="btn btn-mini ajax-get" href="<?php echo U('pass?id='.$vo['id'].'&readable=1');?>">通过</a>
                <?php else: ?>
                    <a class="btn btn-mini ajax-get" href="<?php echo U('pass?id='.$vo['id'].'&readable=0');?>">隐藏</a><?php endif; ?>
            </td>
