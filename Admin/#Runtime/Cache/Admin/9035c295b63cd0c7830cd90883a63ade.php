...
<div class="row-fluid">
	<form class="form-horizontal" action="<?php echo U('edit');?>">
        ...
        <div class="control-group">
            <label class="control-label" for="img_url">图片地址</label>
            <div class="controls">
                <input type="text" id="img_url" name="img_url" class="span8"
                       placeholder="图片地址" value="<?php echo ($info["img_url"]); ?>">
            </div>
        </div>

        <div class="control-group">
            <label class="control-label" for="myEditor">其他</label>
            <div class="controls">
                <input type="text" id="other" name="other" class="span8"
                       placeholder="其他" value="<?php echo ($info["other"]); ?>">
            </div>
        </div>
