...
<input type="hidden" name="id" value="<?php echo ((isset($info["id"]) && ($info["id"] !== ""))?($info["id"]):''); ?>">
  <div class="control-group">
    <label class="control-label" for="name">行为标识</label>
    <div class="controls">
      <input type="text" id="name" name="name" class="span8" placeholder="行为标识" value="<?php echo ($info["name"]); ?>">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="title">行为名称</label>
    <div class="controls">
      <input type="text" name="title" id="title" class="span8" value="<?php echo ($info["title"]); ?>" placeholder="行为名称">
    </div>
  </div>
      <div class="control-group">
  ...
  <div class="control-group">
    <label class="control-label" for="remark">行为描述</label>
    <div class="controls">
      <input type="text" name="remark" id="remark" class="span8" value="<?php echo ($info["remark"]); ?>" placeholder="行为描述">
    </div>
  </div>
    <div class="control-group">
    <label class="control-label" for="rule">行为规则</label>
    <div class="controls">
      <input type="text" name="rule" id="rule" class="span8" value="<?php echo ($info["rule"]); ?>" placeholder="行为规则">
    </div>
  </div>
    <div class="control-group">
    <label class="control-label" for="title">日志规则</label>
    <div class="controls">
      <input type="text" name="log" id="log" class="span8" value="<?php echo ($info["log"]); ?>" placeholder="日志规则">
    </div>
  </div>
  <div class="control-group">
    <div class="controls">
