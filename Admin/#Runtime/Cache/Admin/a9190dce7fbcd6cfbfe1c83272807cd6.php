        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select name="route_id" id="route_id">
                    <?php if(is_array($route)): $i = 0; $__LIST__ = $route;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["id"]); ?>.<?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
