...
<li><a href="javascript:history.back(-1)">返回上一页</a> <span class="divider">/</span></li>
  ...
  <li><a class="btn btn-link ajax-get  confirm" href="<?php echo U('clear');?>">清空日志</a></li>
</ul>
...
<table class="table table-hover table-striped table-bordered">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
			<a class="btn btn-mini" href="<?php echo U('detail?id='.$vo['id']);?>">详细</a>
			<a class="btn btn-mini ajax-get  confirm" href="<?php echo U('deletelog?id='.$vo['id']);?>">删除</a>
			</td>
