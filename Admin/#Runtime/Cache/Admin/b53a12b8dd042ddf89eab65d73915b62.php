...
<div class="row-fluid">
	<form class="form-horizontal" action="<?php echo U('add');?>" method="post">
		...
		<div class="control-group">
			<label class="control-label" for="taobao">淘宝链接</label>
			<div class="controls">
				<input type="text" id="taobao" name="taobao" class="span8"
					   placeholder="淘宝地址(请填写完整, 以http开头)" value="<?php echo ($info["taobao"]); ?>">
			</div>
		</div>
