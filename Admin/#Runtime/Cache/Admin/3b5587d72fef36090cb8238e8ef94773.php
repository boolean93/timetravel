...
<li><a href="javascript:history.back(-1)">返回上一页</a> <span class="divider">/</span></li>
  ...
  <li><a class="btn btn-link" href="<?php echo U('add');?>">添加关系</a></li>
</ul>
...
<table class="table table-hover table-striped table-bordered">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo (getarticletitlebyid($vo["article_id"])); ?></td>
            <td><?php echo ($vo["route_id"]); ?></td>
            <td><?php echo (getroutetitlebyid($vo["route_id"])); ?></td>
			<td>
