...
<ul class="breadcrumb">
	...
	<li><a class="btn btn-link" href="<?php echo U('add');?>">新增角色</a></li>
</ul>
...
<table class="table table-hover table-striped table-bordered">
	...
	<tbody>
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
			<a class="btn btn-mini" href="<?php echo U('auth?id='.$vo['id']);?>">授权</a>
			<a class="btn btn-mini" href="<?php echo U('edit?id='.$vo['id']);?>">编辑</a>
				<a class="btn btn-mini ajax-get  confirm"
				href="<?php echo U('delete?id='.$vo['id']);?>">删除</a></td>
